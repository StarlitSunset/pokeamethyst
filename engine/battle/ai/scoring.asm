...
; 50% chance to greatly encourage this move if the enemy is fast asleep or frostbitten.
...
; (fixed) BUG: "Smart" AI discourages Conversion2 after the first turn (see docs/bugs_and_glitches.md)
	ld a, [wLastPlayerMove]
	and a
	jr z, .discourage
...
; (fixed) BUG: "Smart" AI encourages Mean Look if its own Pokémon is badly poisoned (see docs/bugs_and_glitches.md)
	ld a, [wPlayerSubStatus5]
	bit SUBSTATUS_TOXIC, a
	jr nz, .encourage
