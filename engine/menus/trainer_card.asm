...
TrainerCard_Page3_LoadGFX:
	...
	call Request2bpp
	ld hl, TrainerCard_AmeBadgesOAM
	ld de, BadgeGFX2
	ld hl, vTiles0 tile $00
...
TrainerCard_AmeBadgesOAM:
   ; Template OAM data for Ame badges on the trainer card.
   ; Format:
	; y, x, palette
	; cycle 1: face tile, in1 tile, in2 tile, in3 tile
	; cycle 2: face tile, in1 tile, in2 tile, in3 tile
...
CardStatusGFX: INCBIN "gfx/trainer_card/card_status.2bpp"
   ...
   LeaderGFX2: INCBIN "gfx/trainer_card/ame_leaders.2bpp"
   BadgeGFX:   INCBIN "gfx/trainer_card/johto_badges.2bpp"
   BadgeGFX2:  INCBIN "gfx/trainer_card/ame_badges.2bpp"
