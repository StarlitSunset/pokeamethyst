...
; (fixed) BUG: CheckOwnMon does not check the Day-Care (see docs/bugs_and_glitches.md)
...
; (fixed) BUG: CheckOwnMon only checks the first five letters of OT names (see docs/bugs_and_glitches.md)
