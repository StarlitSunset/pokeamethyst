...
.ornaments:
	...
	db DECO_HANAGOMURA_DOLL ; 22
	db DECO_DAINABEA_DOLL ; 23
	db DECO_AKUERIA_DOLL ; 24
	db DECO_POLIWAG_DOLL ; 25
	db DECO_ENTEI_DOLL ; 26
	...
	db DECO_RAIKOU_DOLL ; 2d
	db DECO_MOLTRES_DOLL ; 2e
	db DECO_UNOWN_DOLL ; 2f
	db DECO_GEODUDE_DOLL ; 30
	db DECO_WOOPER_DOLL ; 31
