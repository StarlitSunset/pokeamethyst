...
UsedSurfScript:
; (fixed) BUG: Surfing directly across a map connection does not load the new map (see docs/bugs_and_glitches.md)
...
.TryFish:
; (fixed) BUG: You can fish on top of NPCs (see docs/bugs_and_glitches.md)
	ld a, [wPlayerState]
	cp PLAYER_SURF_PIKA
	jr z, .fail
	call GetFacingTileCoord
