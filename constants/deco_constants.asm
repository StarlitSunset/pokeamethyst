...
; DecorationIDs indexes (see data/decorations/decorations.asm)
	...
	const DECOFLAG_HANAGOMURA_DOLL
	const DECOFLAG_DAINABEA_DOLL
	const DECOFLAG_AKUERIA_DOLL
	const DECOFLAG_POLIWAG_DOLL
	const DECOFLAG_ENTEI_DOLL
	...
	const DECOFLAG_RAIKOU_DOLL
	const DECOFLAG_MOLTRES_DOLL
	const DECOFLAG_UNOWN_DOLL
	const DECOFLAG_GEODUDE_DOLL
	const DECOFLAG_WOOPER_DOLL
...
; FindOwnedOrnaments.ornaments values (see engine/overworld/decorations.asm)
	...
	const DECO_HANAGOMURA_DOLL
	const DECO_DAINABEA_DOLL
	const DECO_AKUERIA_DOLL
	const DECO_POLIWAG_DOLL
	const DECO_ENTEI_DOLL
	...
	const DECO_RAIKOU_DOLL
	const DECO_MOLTRES_DOLL
	const DECO_UNOWN_DOLL
	const DECO_GEODUDE_DOLL
	const DECO_WOOPER_DOLL
