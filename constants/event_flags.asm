...
; Decorations
	...
	const EVENT_DECO_HANAGOMURA_DOLL
	const EVENT_DECO_DAINABEA_DOLL
	const EVENT_DECO_AKUERIA_DOLL
	const EVENT_DECO_POLIWAG_DOLL
	const EVENT_DECO_ENTEI_DOLL
	...
	const EVENT_DECO_RAIKOU_DOLL
	const EVENT_DECO_MOLTRES_DOLL
	const EVENT_DECO_UNOWN_DOLL
	const EVENT_DECO_GEODUDE_DOLL
	const EVENT_DECO_WOOPER_DOLL
...
; Johto people
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_ZAPDOS
...
; New to Crystal
	...
	const EVENT_OLIVINE_PORT_MEW
	const EVENT_S_PICHU
	const EVENT_LAKE_OF_RAGE_BUTTERFREE
	const EVENT_MEWTWO
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_MOLTRES
	const EVENT_ARTICUNO
	const EVENT_MOUNT_MORTAR_2F_INSIDE_RAIKOU
	const EVENT_RUINS_ENTEI
