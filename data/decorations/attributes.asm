...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    PIKACHU,         SET_UP_DOLL,       EVENT_DECO_PIKACHU_DOLL,            SPRITE_SPICHU
	...
	decoration DECO_DOLL,    MEWTWO,      	  SET_UP_DOLL,       EVENT_DECO_CHARMANDER_DOLL,       	 SPRITE_MEWTWO
	...
	decoration DECO_DOLL,    ARTICUNO,        SET_UP_DOLL,       EVENT_DECO_TENTACOOL_DOLL,          SPRITE_ARTICUNO
