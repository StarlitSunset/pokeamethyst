...
MapGroup_Dungeons:
	...
	map RuinsOfAlphInnerChamberB1F, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_RUINS_OF_ALPH, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map BattleTowerTradeHouse, TILESET_HOUSE, INDOOR, LANDMARK_BATTLE_TOWER, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_DAY, FISHGROUP_SHORE
