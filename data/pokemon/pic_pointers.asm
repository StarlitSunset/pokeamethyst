...
; entries correspond to Pokémon species, two apiece
	...
	dba_pic RaitoraFrontpic
	dba_pic RaitoraBackpic
	...
	dba_pic MadaamuFrontpic
	dba_pic MadaamuBackpic
	...
	dba_pic OnixBackpic
	dba_pic KirinrikiFrontpic
	dba_pic KirinrikiBackpic
	dba_pic KoonyaFrontpic
	dba_pic KoonyaBackpic
	...
	dba_pic SPichuFrontPic
	dba_pic SPichuBackPic
