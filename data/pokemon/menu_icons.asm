...
MonMenuIcons:
	...
	db ICON_HANAGOMURA  ; HANAGOMURA
	db ICON_HONOOGUMA   ; HONOOGUMA
	db ICON_BORUBEAA    ; BORUBEAA
	db ICON_DAINABEA    ; DAINABEA
	db ICON_KURUSU      ; KURUSU
	db ICON_AKUA	    ; AKUA
	db ICON_AKUERIA     ; AKUERIA
	db ICON_MIKON	    ; MIKON
	db ICON_MONJA   	; MONJA
	db ICON_MANBOO      ; MANBOO
	db ICON_IKARI       ; IKARI
	db ICON_BUTTERFREE  ; BUTTERFREE
	db ICON_GURUTESU    ; GURUTESU
	db ICON_PARA        ; PARA 
	db ICON_ANIMON      ; ANIMON
	db ICON_PIDGEY      ; PIDGEY
	db ICON_PIDGEOTTO   ; PIDGEOTTO
	db ICON_PIDGEOT     ; PIDGEOT
	db ICON_SHIBIFUGU   ; SHIBIFUGU
	db ICON_GYOPIN      ; GYOPIN
	db ICON_JARANRA     ; JARANRA
	db ICON_HANEEI      ; HANEEI
	db ICON_HINAAZU     ; HINAAZU
	db ICON_TSUINZU     ; TSUINZU
	db ICON_PIKACHU     ; PIKACHU
	db ICON_RAICHU      ; RAICHU
	db ICON_SANDSHREW   ; SANDSHREW
	db ICON_SANDSLASH   ; SANDSLASH
	db ICON_RINRIN      ; RINRIN
	db ICON_BERURUN     ; BERURUN
	db ICON_NYOROTONO   ; NYOROTONO
	db ICON_MITSUBOSHI  ; MITSUBOSHI
	db ICON_PUCHIKOON   ; PUCHIKOON
	db ICON_TAABAN      ; TAABAN
	...
	db ICON_BETOBEBII   ; BETOBEBII
	db ICON_TEPPOUO     ; TEPPOUO
	db ICON_WATAKKO     ; WATAKKO
	db ICON_BARIRIINA   ; BARIRIINA
	db ICON_MEOWTH      ; MEOWTH
	db ICON_PERSIAN     ; PERSIAN
	db ICON_KOTORA      ; KOTORA
	db ICON_RAITORA     ; RAITORA
	db ICON_TSUBOMITTO  ; TSUBOMITTO
	db ICON_BOMUSHIKAA  ; BOMUSHIKAA
	...
	db ICON_KOONYA      ; KOONYA
	db ICON_KRABBY      ; KRABBY*
	db ICON_KINGLER     ; KINGLER*
	db ICON_POPOKKO     ; POPOKKO
	...
	db ICON_OKUTANK     ; OKUTANK
	db ICON_BARUKII     ; BARUKII
