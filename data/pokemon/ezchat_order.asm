...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, PSYDUCK, PHANPY, GOLDUCK, GOLBAT, GOLEM, GRAVELER, -1
...
.hi_bi_pi: db CLEFFA, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, DAINABEA, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, HONOOGUMA, BORUBEAA, -1
