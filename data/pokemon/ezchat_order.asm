...
.o:        db FERALIGATR, FURRET, OCTILLERY, PRIMEAPE, SENTRET, STANTLER, OMASTAR, OMANYTE, -1
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, FARFETCH_D, CUBONE, MAROWAK, KANGASKHAN, -1
.ki_gi:    db SUNFLORA, GYARADOS, RAPIDASH, NINETALES, GIRAFARIG, BELLOSSOM, KINGDRA, KINGLER, -1
.ku_gu:    db GLOOM, PINECO, GLIGAR, KRABBY, GRANBULL, CROBAT, -1
.ke_ge:    db ABRA, GENGAR, TAUROS, -1
.ko_go:    db MAGIKARP, GASTLY, HAUNTER, MACHOKE, PSYDUCK, PHANPY, GOLDUCK, GOLBAT, GOLEM, GRAVELER, -1
...
.su_zu:    db SUICUNE, STARMIE, SCYTHER, ZUBAT -1
.se_ze:    db CELEBI, -1
.so_zo:    db WOBBUFFET, -1
.ta_da:    db HORSEA, EXEGGCUTE, -1
.chi_dhi:  db CHIKORITA, CHINCHOU, -1
.tsu_du:   db SHUCKLE, -1
.te_de:    db REMORAID, DELIBIRD, HOUNDOUR, AMPHAROS, -1
.to_do:    db DODUO, DODRIO, SMEARGLE, TENTACRUEL, TOGETIC, TOGEPI, GOLDEEN, DONPHAN, -1
.na:       db ODDISH, EXEGGUTOR, -1
.ni:       db MEOWTH, SNEASEL, POLIWHIRL, POLITOED, POLIWRATH, POLIWAG, -1
.nu:       db QUAGSIRE, -1
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
...
.hi_bi_pi: db CLEFFA, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, DAINABEA, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, HONOOGUMA, BORUBEAA, -1
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, HANAGOMURA, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
...
.ma:       db MAGCARGO, SLUGMA, QUILAVA, BELLSPROUT, MARILL, AZUMARILL, ELECTRODE, MANKEY, MANTINE, -1
.mi:       db DRATINI, MEW, MEWTWO, MILTANK, -1
.mu:       db MISDREAVUS, SMOOCHUM, -1
.me:       db MEGANIUM, DITTO, TENTACOOL, MAREEP, -1
.mo:       db FLAAFFY, TANGELA, -1
