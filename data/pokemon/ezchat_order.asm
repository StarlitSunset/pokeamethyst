...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, KAKUNA, PSYDUCK, PHANPY, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT, -1
...
.hi_bi_pi: db CLEFFA, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, DAINABEA, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, HONOOGUMA, BORUBEAA, -1
