...
.o:        db FERALIGATR, FURRET, OCTILLERY, SENTRET, STANTLER, OMASTAR, OMANYTE, -1
...
.ko_go:    db MAGIKARP, GASTLY, HAUNTER, MACHOKE, PHANPY, GOLBAT, GOLEM, GRAVELER, -1
