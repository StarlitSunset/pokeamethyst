...
TaabanFrontpic:      INCBIN "gfx/pokemon/taaban/front.animated.2bpp.lz"
...
BorubeaaFrontpic:    INCBIN "gfx/pokemon/borubeaa/front.animated.2bpp.lz"
...
MonjaFrontpic:	     INCBIN "gfx/pokemon/monja/front.animated.2bpp.lz"
...
NyorotonoFrontpic:   INCBIN "gfx/pokemon/nyorotono/front.animated.2bpp.lz"
...
AnimonFrontpic:      INCBIN "gfx/pokemon/animon/front.animated.2bpp.lz"
...
TsuinzuFrontpic:     INCBIN "gfx/pokemon/tsuinzu/front.animated.2bpp.lz"
...
BarukiiFrontpic:     INCBIN "gfx/pokemon/barukii/front.animated.2bpp.lz"
...
BomushikaaFrontpic:  INCBIN "gfx/pokemon/bomushikaa/front.animated.2bpp.lz"
...
KoonyaFrontpic:      INCBIN "gfx/pokemon/koonya/front.animated.2bpp.lz"
PuchikoonFrontpic:   INCBIN "gfx/pokemon/puchikoon/front.animated.2bpp.lz"
...
GyopinFrontpic:      INCBIN "gfx/pokemon/gyopin/front.animated.2bpp.lz"
TeppouoFrontpic:     INCBIN "gfx/pokemon/teppouo/front.animated.2bpp.lz"
...
MikonFrontpic: 	     INCBIN "gfx/pokemon/mikon/front.animated.2bpp.lz"
...
BerurunFrontpic:     INCBIN "gfx/pokemon/berurun/front.animated.2bpp.lz"
...
KirinrikiFrontpic:   INCBIN "gfx/pokemon/kirinriki/front.animated.2bpp.lz"
...
BaririinaFrontpic:   INCBIN "gfx/pokemon/baririina/front.animated.2bpp.lz"
HanekkoFrontpic:     INCBIN "gfx/pokemon/hanekko/front.animated.2bpp.lz"
...
HonoogumaFrontpic:   INCBIN "gfx/pokemon/honooguma/front.animated.2bpp.lz"
...
HinaazuFrontpic:     INCBIN "gfx/pokemon/hinaazu/front.animated.2bpp.lz"
...
MadaamuFrontpic:     INCBIN "gfx/pokemon/madaamu/front.animated.2bpp.lz"
ChinchouFrontpic:    INCBIN "gfx/pokemon/chinchou/front.animated.2bpp.lz"
ShibifuguFrontpic:   INCBIN "gfx/pokemon/shibifugu/front.animated.2bpp.lz"
ChampionPic:         INCBIN "gfx/trainers/champion.2bpp.lz"
JaranraFrontpic:     INCBIN "gfx/pokemon/jaranra/front.animated.2bpp.lz"
MagikarpFrontpic:    INCBIN "gfx/pokemon/magikarp/front.animated.2bpp.lz"
DainabeaFrontpic:    INCBIN "gfx/pokemon/dainabea/front.animated.2bpp.lz"
...
MitsuboshiFrontpic:  INCBIN "gfx/pokemon/mitsuboshi/front.animated.2bpp.lz"
...
TsubomittoFrontpic:  INCBIN "gfx/pokemon/tsubomitto/front.animated.2bpp.lz"
...
TaabanBackpic:       INCBIN "gfx/pokemon/taaban/back.2bpp.lz"
...
OkutankFrontpic:     INCBIN "gfx/pokemon/okutank/front.animated.2bpp.lz"
BetobebiiFrontpic:   INCBIN "gfx/pokemon/betobebii/front.animated.2bpp.lz"
...
TeppouoBackpic:      INCBIN "gfx/pokemon/teppouo/back.2bpp.lz"
...
HanekkoBackpic:      INCBIN "gfx/pokemon/hanekko/back.2bpp.lz"
...
BorubeaaBackpic:     INCBIN "gfx/pokemon/borubeaa/back.2bpp.lz"
...
MitsuboshiBackpic:   INCBIN "gfx/pokemon/mitsuboshi/back.2bpp.lz"
...
TsubomittoBackpic:   INCBIN "gfx/pokemon/tsubomitto/back.2bpp.lz"
MagmarBackpic:       INCBIN "gfx/pokemon/magmar/back.2bpp.lz"
KoonyaBackpic:       INCBIN "gfx/pokemon/koonya/back.2bpp.lz"
...
HanagomuraFrontpic:  INCBIN "gfx/pokemon/hanagomura/front.animated.2bpp.lz"
...
NyorotonoBackpic:    INCBIN "gfx/pokemon/nyorotono/back.2bpp.lz"
...
OkutankBackpic:      INCBIN "gfx/pokemon/okutank/back.2bpp.lz"
...
BerurunBackpic:      INCBIN "gfx/pokemon/berurun/back.2bpp.lz"
...
PuchikoonBackpic:    INCBIN "gfx/pokemon/puchikoon/back.2bpp.lz"
...
MonjaBackpic:	     INCBIN "gfx/pokemon/monja/back.2bpp.lz"
...
BomushikaaBackpic:   INCBIN "gfx/pokemon/bomushikaa/back.2bpp.lz"
FurretBackpic:       INCBIN "gfx/pokemon/furret/back.2bpp.lz"
MikonBackpic:  	     INCBIN "gfx/pokemon/mikon/back.2bpp.lz"
...
GyopinBackpic:       INCBIN "gfx/pokemon/gyopin/back.2bpp.lz"
VulpixBackpic:       INCBIN "gfx/pokemon/vulpix/back.2bpp.lz"
HinaazuBackpic:      INCBIN "gfx/pokemon/hinaazu/back.2bpp.lz"
...
BetobebiiBackpic:    INCBIN "gfx/pokemon/betobebii/back.2bpp.lz"
...
WatakkoFrontpic:     INCBIN "gfx/pokemon/watakko/front.animated.2bpp.lz"
...
HonoogumaBackpic:    INCBIN "gfx/pokemon/honooguma/back.2bpp.lz"
...
BarukiiBackpic:      INCBIN "gfx/pokemon/barukii/back.2bpp.lz"
...
MadaamuBackpic:      INCBIN "gfx/pokemon/madaamu/back.2bpp.lz"
...
BaririinaBackpic:    INCBIN "gfx/pokemon/baririina/back.2bpp.lz"
...
GurutesuFrontpic:    INCBIN "gfx/pokemon/gurutesu/front.animated.2bpp.lz"
...
ShibifuguBackpic:    INCBIN "gfx/pokemon/shibifugu/back.2bpp.lz"
...
ManbooFrontpic:      INCBIN "gfx/pokemon/manboo/front.animated.2bpp.lz"
...
JaranraBackpic:      INCBIN "gfx/pokemon/jaranra/back.2bpp.lz"
...
DainabeaBackpic:     INCBIN "gfx/pokemon/dainabea/back.2bpp.lz"
...
HanagomuraBackpic:   INCBIN "gfx/pokemon/hanagomura/back.2bpp.lz"
...
ManbooBackpic:       INCBIN "gfx/pokemon/manboo/back.2bpp.lz"
PopokkoFrontpic:     INCBIN "gfx/pokemon/popokko/front.animated.2bpp.lz"
...
TsuinzuBackpic:      INCBIN "gfx/pokemon/tsuinzu/back.2bpp.lz"
...
PopokkoBackpic:      INCBIN "gfx/pokemon/popokko/back.2bpp.lz"
...
WatakkoBackpic:      INCBIN "gfx/pokemon/watakko/back.2bpp.lz"
