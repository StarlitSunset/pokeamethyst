	...
	const TEAMROCKETBASEB2F_ZAPDOS
...
TeamRocketBaseB2F_MapScripts:
	...
	scene_script TeamRocketBaseB2FNoop4Scene, SCENE_TEAMROCKETBASEB2F_ZAPDOS
...
RocketElectrode1:
	...
	iffalse TeamRocketBaseB2FReloadMap
	checkevent EVENT_TEAM_ROCKET_BASE_B2F_ZAPDOS
	iffalse TeamRocketBaseB2FReloadMap
	reloadmapafterbattle
...
RocketZapdos:
	cry ZAPDOS
	loadwildmon ZAPDOS, 30
	startbattle
	iftrue TeamRocketBaseB2FReloadMap
	disappear TEAMROCKETBASEB2F_ZAPDOS
...
TeamRocketBaseB2F_MapEvents:
	...
	object_event  7,  9, SPRITE_MOLTRES, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RocketZapdos, EVENT_TEAM_ROCKET_BASE_B2F_ZAPDOS
	...
	object_event 22,  9, SPRITE_VOLTORB, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEAM_ROCKET_BASE_B2F_ZAPDOS
