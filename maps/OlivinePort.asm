...
OlivinePort_MapEvents:
	...
	object_event 16, 32, SPRITE_MEW, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_OW_PINK, OBJECTTYPE_SCRIPT, 0, Mew, EVENT_OLIVINE_PORT_SPRITES_BEFORE_HALL_OF_FAME
